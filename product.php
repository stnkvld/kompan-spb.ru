<?php require_once("header.php"); ?>
    ...
    <section id="product-card" class="product-card novelty">
        <div class="container">
            <div class="title-and-back">
                <h2 class="title">PCM310101</h2>
                <button type="button" class="btn btn-back">Вернуться в каталог</button>
            </div>
            <div class="photos-and-specifications">
                <div class="left">
                    <div id="slider-photos" class="slider-photos swiper-container">
                        <img src="images/novelty.png" class="novelty">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src="images/slider-product-1.png">
                            </div>
                            <div class="swiper-slide">
                                <img src="images/slider-product-1.png">
                            </div>
                ...
                <div class="right">
                    <ul class="specifications">
                        ...
                        <li>
                            <span class="title">Возрастные категории:</span>
                            <div class="line"></div>
                    ...
                    <div class="add-to-compilation">
                        <span>Добавить в мою подборку</span>
                    ...
                    <div class="you-know">
                        <h3 class="title">Отправив заявку менеджеру вы узнаете</h3>
                        <ul class="options">
                            <li>
                                <img src="images/you-know-price.png">
                                <span>стоимость</span>
                            </li>
                            <li>
                                <img src="images/you-know-availability.png">
                                <span>наличие</span>
                            </li>
                            <li>
                                <img src="images/you-know-term.png">
                                <span>срок поставки</span>
                            </li>
                            <li>
                                <img src="images/you-know-answers.png">
                                <span>ответы на<br>свои вопросы</span>
                            </li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="drawings-and-application">
                <div class="drawings">
                    <h3 class="title">Чертежи</h3>
                    <div class="photos">
                        <img src="images/drawing-1.png">
                        <img src="images/drawing-1.png">
                    </div>
                </div>
